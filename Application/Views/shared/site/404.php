...
<head>
    ...
    <title>2T Bakery | Page Not Found</title>
    <meta charset="UTF-8">
...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar nav-main navbar-expand-md bg-light navbar-light">
            <div class="logo">
                <a class="navbar-brand" href="./"><img src="./public/site/img/home/logo/logo.png" alt="2T Bakery"></a>
            </div>
...
toggle between hiding and showing the dropdown content */
    ...
    function showSearchResult(str) {
        ...
        xmlhttp.open("GET", "/2tbakery/?controller=product&action=ajaxSearch&product=" + str, true);
        xmlhttp.send();
    }
</script>
