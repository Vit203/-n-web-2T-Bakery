            ...
            <div class="container-fluid p-0" style="background-color: white;">
                <div class="row contact-block m-0">
                    ...
                    <ul class="contact-span m-0 hidden-xs hidden-sm">
                        <li><i class="fas fa-map-marker-alt"></i><span>235 Hoang Quoc Viet, Ha Noi</span>
                        </li>
                        <li><i class="fas fa-phone-alt"></i><span>0933257164</span></li>
                    </ul>
        ...
        <nav class="navbar nav-main navbar-expand-md bg-light navbar-light">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav ml-auto my-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href='./?controller=cart' title="cart"><i class="fas fa-shopping-cart"></i><span class="badge badge-warning navbar-badge" id="cart-quantity"><?= $_SESSION['total_quantity'] ?? 0 ?></span></a>
                    </li>
