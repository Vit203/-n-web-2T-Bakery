                ...
                <ul id="chef-list">
                    ...
                    <li>
                        <div class="chef-block">
                            <div class="chef-img">
                                <img src="./public/site/img/about/toan.png" alt="" style=" border-radius: 100%">
                            </div>
                            <div class="chef-info">
                                <h5>Duong Duc Toan</h5>
                                <p>a prety lady u dont have to be alone</p>
                            </div>
                            <div class="chef-social">
                                <a href="https://www.facebook.com/vitconlonton203"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-google-plus-g"></i></a>
                                <a href="#"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="chef-block">
                            <div class="chef-img">
                                <img src="./public/site/img/about/toan2.png" alt="" style=" border-radius: 100%">
                            </div>
                            <div class="chef-info">
                                <h5>Toan Duong Duc</h5>
                                <p>hehe 😏</p>
                            </div>
                            <div class="chef-social">
                                <a href="https://www.facebook.com/vitconlonton203"><i class="fab fa-facebook-f"></i></a>
                    ...
                    <li>
                        <div class="chef-block">
                            <div class="chef-img">
                                <img src="./public/site/img/about/tai1.png" alt="" style=" border-radius: 100%">
                            </div>
                            <div class="chef-info">
                                <h5>Duong Van Tai</h5>
                                <p>Tao khong sai thu sai lam chinh la the gioi nayyyyy</p>
                            </div>
                            <div class="chef-social">
                                <a href="https://www.facebook.com/profile.php?id=100025138370730"><i class="fab fa-facebook-f"></i></a>
                                <a href="#"><i class="fab fa-google-plus-g"></i></a>
                                <a href="#"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="chef-block">
                            <div class="chef-img">
                                <img src="./public/site/img/about/bxd.jpg" alt="" style="background: lightblue; border-radius: 100%">
                            </div>
                            <div class="chef-info">
                                <h5>Nguyen Ngoc Bich</h5>
                                <p>bichxinhdep</p>
                            </div>
                            <div class="chef-social">
                                <a href="#"><i class="fab fa-facebook-f"></i></a>
