                        ...
                        <div class="bill-form-block">
                            ...
                            <form method="POST" action="./?controller=checkout&action=process" name="checkoutForm" onsubmit="return validateCheckoutForm();">
                                ...
                                <div class="form-group" style="border-top: 1px solid lightgray; padding-top: 1.5rem;">
                                    <button type="submit" class="btn-root border-root place-order-btn">Place order 
                                    </button>
                                    <button type="submit" name = "redirect" class="btn-root border-root place-order-btn">Online Banking 
                                    </button>
                                </div>
                            </form>
                        </div>
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <p> <i class="discount fas fa-phone-alt mr-2" style="font-size: 13px;"></i>(+84)345 573 088
                                        <i class="discount far fa-envelope ml-4 mr-2"></i>2tbakeryy@gmail.com
                                    </p>
                                </td>
                            </tr>
                        </tfoot>
