            ...
            <ul>
                ...
                <li class="offer-info">
                    <div>
                        ...
                        <p class="p-lorem">This cake looks absolutely stunning! The decoration is so intricate and elegant..</p>
                            ...
                            <li>
                                ...
                                <div class="new-pro-block">
                                    ...
                                    <a id="add-to-cart-btn<?= $product['id'] ?>" class="swalDefaultSuccess " onclick="onAddToCartAjax(<?= $product['id'] ?>)">
                                        <button><i class="fas fa-shopping-cart" style="font-size:13px"></i><span> ADD TO
                                                CART</span></button>
                                    </a>
                ...
                <div class="carousel-inner" id="testimonial-list" role="listbox">
                    <div class="mySlides fade testimonial-item">
                        <div class="testimonial-block">
                            ...
                            <div class="customer-info">
                                ...
                                <p> The bakery is a gem, offering a delightful selection of freshly baked 
                                    treats in a cozy atmosphere. With friendly staff and a commitment 
                                    to quality, it's a must-visit for any pastry lover.
                                    <br>
                                </p>
                                ...
                                <h5> Luu Dinh Luyen </h5>
                                <span id="job"> Tiktoker </span>
                            </div>
                    ...
                    <div class="mySlides fade testimonial-item">
                        <div class="testimonial-block">
                            ...
                            <div class="customer-info">
                                <img src="./public/site/img/home/customer/testimonial.png">
                                <p> The bakery is a gem, offering a delightful selection of freshly baked treats in a cozy atmosphere. 
                                    With friendly staff and a commitment to quality, it's a must-visit for any pastry lover.
                                    <br>
                                </p>
                                <span id="star-icon"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></span>
                                <h5> Tuan Cui</h5>
                    ...
                    <div class="mySlides fade testimonial-item">
                        <div class="testimonial-block">
                            ...
                            <div class="customer-info">
                                <img src="./public/site/img/home/customer/testimonial.png">
                                <p> Entering this bakery is like stepping into a sweet paradise. 
                                    The enticing aroma of freshly baked goods fills the air, inviting you to indulge in their irresistible pastries. 
                                    With attentive staff and mouthwatering treats, it's a must-visit for anyone with a sweet tooth
                                    <br>
                                </p>
                                <span id="star-icon"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></span>
                                <h5> Kaysar Dung Pham </h5>
                                <span id="job"> Smoker </span>
                            </div>
                            <div class="customer-img">
